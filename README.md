...
Чтобы скопилировать css нужно установить зависимости: ``npm i`` и запустить ``npm run sass``
Чтобы обновлять стили в процессе разаработки используйте ``npm run watch``
